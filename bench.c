...
int validate()
{
	...
	for (cnt = 1 ; cnt < 100 ; cnt++)
	{
		...
		tailsort(a_array, cnt, sizeof(int), cmp_int);
	...
	for (cnt = 0 ; cnt < 1000 ; cnt++)
	{
        ...
        tailsort(r_array + max / 4 * 0, max / 4, sizeof(int), cmp_int);
        tailsort(r_array + max / 4 * 1, max / 4, sizeof(int), cmp_int);
        tailsort(r_array + max / 4 * 2, max / 4, sizeof(int), cmp_int);
        tailsort(r_array + max / 4 * 3, max / 4, sizeof(int), cmp_int);
...
int main(int argc, char **argv)
{
	...
	test_sort(la_array, lr_array, lv_array, max, max, samples, repetitions, tailsort,        "tailsort",       "random order", sizeof(long long), cmp_long);
	...
	memcpy(v_array, r_array, max * sizeof(int));
	tailsort(v_array, max, sizeof(int), cmp_int);

	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, tailsort,        "tailsort",       "random order", sizeof(int), cmp_int);
	...
	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, tailsort,        "tailsort",       "ascending", sizeof(int), cmp_int);
	...
	for (cnt = 0 ; cnt < max ; cnt++)
	{
        ...
        memcpy(v_array, r_array, max * sizeof(int));
        tailsort(v_array + max / 4 * 0, max / 4, sizeof(int), cmp_int);
        tailsort(v_array + max / 4 * 1, max / 4, sizeof(int), cmp_int);
        tailsort(v_array + max / 4 * 2, max / 4, sizeof(int), cmp_int);
        tailsort(v_array + max / 4 * 3, max / 4, sizeof(int), cmp_int);
        memcpy(r_array, v_array, max * sizeof(int));

	tailsort(v_array, max, sizeof(int), cmp_int);

	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, tailsort,        "tailsort",       "ascending saw", sizeof(int), cmp_int);
	...
	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, tailsort,        "tailsort",        "generic order", sizeof(int), cmp_int);
	...
	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, tailsort,        "tailsort",        "descending order", sizeof(int), cmp_int);
	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, qsort,           "qsort",           "descending order", sizeof(int), cmp_int);
        ...
        memcpy(v_array, r_array, max * sizeof(int));
        tailsort(v_array, max, sizeof(int), cmp_int);
	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, tailsort,        "tailsort",        "descending saw", sizeof(int), cmp_int);
	...
	memcpy(v_array, r_array, max * sizeof(int));
	tailsort(v_array, max * 3 / 4, sizeof(int), cmp_int);
	memcpy(r_array, v_array, max * sizeof(int));
	tailsort(v_array, max, sizeof(int), cmp_int);

	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, tailsort,        "tailsort",        "random tail", sizeof(int), cmp_int);
	...
	for (cnt = 0 ; cnt < max ; cnt++)
	{
        ...
        memcpy(v_array, r_array, max * sizeof(int));
	tailsort(v_array, max / 2, sizeof(int), cmp_int);

	memcpy(r_array, v_array, max * sizeof(int));
	tailsort(v_array, max, sizeof(int), cmp_int);

	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, tailsort,        "tailsort",        "random half", sizeof(int), cmp_int);
	...
	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, tailsort,        "tailsort",       "wave order", sizeof(int), cmp_int);
	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, qsort,           "qsort",          "wave order", sizeof(int), cmp_int);

	test_sort(a_array, r_array, v_array, max, max, samples, repetitions, tailsort,        "tailsort",       "stable", sizeof(int), cmp_stable);
	...
	if (max >= 4)
	{
		...
		tailsort(v_array, 8, sizeof(int), cmp_int);

		test_sort(a_array, r_array, v_array, 1, 4, 100, 8192, tailsort,        "tailsort",          "random 1-4", sizeof(int), cmp_int);
	...
	if (max >= 8)
	{
		...
		test_sort(a_array, r_array, v_array, 5, 8, 100, 8192, tailsort,        "tailsort",          "random 5-8", sizeof(int), cmp_int);
	...
	if (max >= 16)
	{
		...
		tailsort(v_array, 16, sizeof(int), cmp_int);

		test_sort(a_array, r_array, v_array, 9, 15, 100, 8192, tailsort,        "tailsort",          "random 9-15", sizeof(int), cmp_int);
	...
	if (max >= 64)
	{
		...
		tailsort(v_array, 64, sizeof(int), cmp_int);

		test_sort(a_array, r_array, v_array, 16, 63, 100, 4096, tailsort,        "tailsort",        "random 16-63", sizeof(int), cmp_int);
	...
	if (max >= 128)
	{
		...
		tailsort(v_array, 128, sizeof(int), cmp_int);

		test_sort(a_array, r_array, v_array, 64, 127, 100, 2048, tailsort,        "tailsort",        "random 64-127", sizeof(int), cmp_int);
	...
	if (max >= 256)
	{
		...
		tailsort(v_array, 256, sizeof(int), cmp_int);

		test_sort(a_array, r_array, v_array, 127, 255, 100, 1024, tailsort,        "tailsort",        "random 128-255", sizeof(int), cmp_int);
	...
	if (max >= 512)
	{
		...
		tailsort(v_array, 512, sizeof(int), cmp_int);

		test_sort(a_array, r_array, v_array, 256, 511, 100, 512, tailsort,        "tailsort",        "random 256-511", sizeof(int), cmp_int);
	...
	if (max >= 1024)
	{
		...
		tailsort(v_array, 1024, sizeof(int), cmp_int);

		test_sort(a_array, r_array, v_array, 512, 1023, 100, 256, tailsort,        "tailsort",        "random 512-1023", sizeof(int), cmp_int);
	...
	if (max >= 2048)
	{
		...
		tailsort(v_array, 2048, sizeof(int), cmp_int);

		test_sort(a_array, r_array, v_array, 1024, 2047, 100, 128, tailsort,        "tailsort",          "random 1024-2047", sizeof(int), cmp_int);
	...
	if (max >= 4096)
	{
		...
		tailsort(v_array, 4096, sizeof(int), cmp_int);

		test_sort(a_array, r_array, v_array, 2048, 4095, 100, 64, tailsort,        "tailsort",          "random 2048-4095", sizeof(int), cmp_int);
